...
* Select the product you need to verify (the product you purchased, ex: Auto Showroom - Car Dealership WordPress Theme).
...
![verify-license.png](img/verify-license.png)
...
![add-ticket.png](img/add-ticket.png)

![compose-ticket.png](img/compose-ticket.png)
