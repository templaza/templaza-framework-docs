...
Field groups are created to attach fields to Classes. Each field group contains a title, Slug, Parent Custom Field Group, Description, and Branch Assignment.

## Creating a New Field Group

![add-field-group.png](./img/add-field-group.png)
